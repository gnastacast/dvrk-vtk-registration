...
from amoebaAnnealed import amoeba
import os
import time
...
for idx in range(0,len(manualRegs)) :
	...
	for innerIdx in range(0,annealedIterations) :
		...
		amoeba(s,[10,10,10,10,10,10],afunc,ftolerance=.0005,xtolerance=.0005)
		pos = cylinderActor.GetPosition()
		rot = cylinderActor.GetOrientation()
		s = [pos[0],pos[1],pos[2],rot[0],rot[1],rot[2]]
