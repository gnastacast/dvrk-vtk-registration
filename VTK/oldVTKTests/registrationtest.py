...
actualRegs = iterateStates("registrationTests/reg_manual.txt")

annealedIterations = 50
annealRegs = []
for outerIdx in range(0,len(actualRegs)) :
	for innerIdx in range(0,annealedIterations) :
		...
		annealRegs = annealRegs + [reg.annealingRegistration(actualRegs[outerIdx])]
